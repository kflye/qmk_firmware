...
LAYOUT_keychron_v1_wrapper(\
    ...
    K200,       K201,    K202,    K203,    K204,    K205,    XXX,     K206,    K207,    K208,    K209,    K210,    KC_RSFT,     KC_UP,          \
    KC_LGUI,    K303,    K304,                K305,                                            K306,   K307,   K308,   KC_LEFT, KC_DOWN, KC_RGHT\
)

#define LAYOUT_base_wrapper(...) LAYOUT_keychron_v1_base(__VA_ARGS__)

#undef _________________THUMB_RIGHT_______________
#define _________________THUMB_RIGHT_______________     LT(_SYM,KC_TAB),   LT(_NUM,KC_TAB),   LT(_FUN, KC_RGUI), KC_NO,             KC_NO,             KC_NO             
